...
// in flutter_practical_21/test/bloc/auth_block_test.dart.
...
import 'package:flutter_practical_21/data/domain/entity/user_entity.dart'
    as _i5;
import 'package:flutter_practical_21/data/domain/repositories/auth_repository.dart'
    as _i2;
import 'package:flutter_practical_21/data/domain/usecases/login.dart' as _i3;
import 'package:flutter_practical_21/data/domain/usecases/register.dart' as _i6;
...
class MockLoginUseCase extends _i1.Mock implements _i3.LoginUseCase {
  ...
  @override
  _i4.Future<_i5.UserEntity?> call(String? email, String? password) =>
      (super.noSuchMethod(
...
class MockRegisterUseCase extends _i1.Mock implements _i6.RegisterUseCase {
  ...
  @override
  _i4.Future<void> call(_i5.UserEntity? user) =>
      (super.noSuchMethod(
